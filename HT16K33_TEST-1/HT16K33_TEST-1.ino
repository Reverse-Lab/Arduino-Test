...
void loop ()
{
   ...
   writeInteger(display1, j);   // write integer count to display 2
...
void initHT16K33()
{
  ...
  writeCommand(HT16K33_ADDRESS1, HT16K33_ON);         // Turn on system oscillator
  writeCommand(HT16K33_ADDRESS1, HT16K33_DISPLAYON);  // Display on
  writeCommand(HT16K33_ADDRESS1, HT16K33_DIM);        // Set brightness

  writeCommand(HT16K33_ADDRESS2, HT16K33_ON);         // Turn on system oscillator
  writeCommand(HT16K33_ADDRESS2, HT16K33_DISPLAYON);  // Display on
  writeCommand(HT16K33_ADDRESS2, HT16K33_DIM);        // Set brightness
}
...
void blinkHT16K33(int time) 
{
  ...
  writeCommand(HT16K33_ADDRESS1, HT16K33_BLINKON);  // Turn on blink
  delay(1000*time);
  writeCommand(HT16K33_ADDRESS1, HT16K33_BLINKOFF);  // Turn on blink

  writeCommand(HT16K33_ADDRESS2, HT16K33_BLINKON);  // Turn on blink
  delay(1000*time);
  writeCommand(HT16K33_ADDRESS2, HT16K33_BLINKOFF);  // Turn on blink
}
